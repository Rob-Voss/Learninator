...
class HexShape extends Hex {
  ...
  constructor(hex, layout, opts) {
    ...
    let center = this.layout.hexToPixel(this);
    this.center = new Vec(center.x, center.y);
  ...
  addCheats() {
    ...
    if (this.cheats.position && this.posText === undefined) {
      ...
      this.posText.position.set(this.center.x - 16, this.center.y - 10);
    ...
    if (this.cheats.gridLocation && this.gridText === undefined) {
      ...
      this.gridText.position.set(this.center.x - 12, this.center.y + 2);
