...
DebugDraw = function (canvas) {
    ...
    this.mSettings = { canvasScale: 1, viewZoom: 1 };
};
goog.inherits(DebugDraw, box2d.b2Draw);
DebugDraw.prototype.mCanvas = null;
DebugDraw.prototype.mCtx = null;
DebugDraw.prototype.mSettings = null;
...
DebugDraw.prototype.DrawPoint = function (p, size, color) {
    ...
    size /= this.mSettings.viewZoom;
    size /= this.mSettings.canvasScale;
    var hsize = size / 2;
    ctx.fillRect(p.x - hsize, p.y - hsize, size, size);
};
DebugDraw.prototype.DrawString = function (x, y, format, varArgs) {
    var ctx = this.mCtx;
...
DebugDraw.prototype.DrawStringWorld = function (x, y, format, var_args) {
    ...
    // world -> viewport
    var vt = this.mSettings.viewCenter;
    box2d.b2SubVV(p, vt, p);
    var vr = this.mSettings.viewRotation;
    box2d.b2MulTRV(vr, p, p);
    var vs = this.mSettings.viewZoom;
    box2d.b2MulSV(vs, p, p);

    // viewport -> canvas
    var cs = this.mSettings.canvasScale;
    box2d.b2MulSV(cs, p, p);
    p.y *= -1;
    var cc = DebugDraw.prototype.DrawStringWorld.s_cc.SetXY(0.5 * this.mCanvas.width, 0.5 * this.mCanvas.height);
...
(function (steer) {
    var MathUtil = (function () {
        ...
        MathUtil.angleBetweenPt = function (pt1, pt2) {
        ...
        var ItemBase = (function () {
            ...
            ItemBase.addCounter = function (type) {
                if (ItemBase.uniqueNameCounters[type] === null ||
                    ItemBase.uniqueNameCounters[type] === undefined)
    ...
    (function (item) {
        var Creator = (function () {
            ...
            Creator.createInfoCheckDefault = function (createInfo) {
                ...
                if (copyInfo.x === null || copyInfo.x === undefined)
                    copyInfo.x = 0;
                if (copyInfo.y === null || copyInfo.y === undefined)
                    copyInfo.y = 0;
                if (copyInfo.dynamic === null || copyInfo.dynamic === undefined)
            ...
            Creator.createCircle = function (createInfo) {
                ...
                if (cinfo.radius === null || cinfo.radius === undefined)
            ...
            Creator.createUnit = function (createInfo) {
                ...
                if (cinfo.maxSpeed === null || cinfo.maxSpeed === undefined)
                    console.error("createCircle CreateInfo maxSpeed null");
                if (cinfo.maxForce === null || cinfo.maxForce === undefined)
            ...
            Creator.createPolygon = function (createInfo) {
                if (!Creator.domain)
                    console.error("Creator Domain reference not found!");
                var cinfo = Creator.createInfoCheckDefault(createInfo);
                if (cinfo.dynamic === null || cinfo.dynamic === undefined)
                    cinfo.dynamic = false;
                ...
                if (cinfo.asBoxCenter) {
                    if (cinfo.widthHalf === null || cinfo.widthHalf === undefined)
                        console.error("createPolygon asBox widthHalf is null");
                    if (cinfo.heightHalf === null || cinfo.heightHalf === undefined)
                ...
                if (cinfo.asPolygon) {
                    if (cinfo.vertices === null || cinfo.vertices === undefined) {
            ...
            Creator.createPolygonBorder = function (createInfo) {
                ...
                if (cinfo.asPolygonBorder) {
                    if (cinfo.polygonBorderWidth === null ||
                        cinfo.polygonBorderWidth === undefined ||
                        cinfo.polygonBorderTL === null ||
                        cinfo.polygonBorderTL === undefined ||
                        cinfo.polygonBorderBR === null ||
                        cinfo.polygonBorderBR === undefined) {
            ...
            Creator.createSensorArea = function (createInfo) {
                ...
                if (cinfo.asBoxCenter) {
                    if (cinfo.heightHalf === null ||
                        cinfo.heightHalf === undefined ||
                        cinfo.widthHalf === null ||
                        cinfo.widthHalf === undefined)
            ...
            Creator.checkRequireInfos = function (createInfo, list) {
                ...
                var errors = [];
                for (var s = 0; s < len; s++) {
                    if (createInfo[lists[s]] === null || createInfo[lists[s]] === undefined)
                        errors.push(lists[s]);
                }
                return errors;
            };
...
(function (steer) {
    ...
    var Domain = (function () {
        ...
        Domain.prototype.createBox2dDebugDraw = function (canvasId, flag) {
            if (this.b2World === null || this.b2World === undefined) {
    ...
    (function (controls) {
        var BasicControls = (function () {
            ...
            BasicControls.wander = function (unit) {
                if (unit.wanderRadius === null ||
                    unit.wanderRadius === undefined ||
                    unit.wanderRatioDeg === null ||
                    unit.wanderRatioDeg === undefined ||
                    unit.wanderCurrentAngle === null ||
                    unit.wanderCurrentAngle === undefined) {
                ...
                var wanderForce = steer.Vector.fromAngle(unit.wanderCurrentAngle);
                wanderForce.mult(unit.wanderRadius);
    ...
    (function (controls) {
        var AvoidControls = (function () {
            ...
            AvoidControls.avoidObstacle = function (unit) {
                ...
                for (var s = 0; s < rayInfo.length; s += 2) {
                    var callBack = box2d.RaycastCallback();
    ...
    (function (controls) {
        var PathAreaControls = (function () {
            ...
            PathAreaControls.followPath = function (unit, path) {
                ...
                var frontLoc = steer.Vector.fromAngle(steer.MathUtil.angleBetweenPt(pathPt1, pathPt2), unit.maxSpeed * unit.pathOnFrontRatio);
            ...
            PathAreaControls.gridmapForce = function (unit, gridmap) {
                if (gridmap.velocityData === null || gridmap.velocityData === undefined)
                    return new steer.Vector();
    ...
    (function (render) {
        var PixiDebugRenderer = (function (_super) {
            ...
            function PixiDebugRenderer(domain, stage, renderer, w, h) {
                ...
                this.guideGraphic = new PIXI.Graphics();
                this.quadGraphic = new PIXI.Graphics();
                this.guideContainer.addChild(this.guideGraphic);
            ...
            PixiDebugRenderer.prototype.visualRender = function (delta) {
                var _this = this;
                this.domain.gridMaps.each(function (item) {
                    if (item.pixiDebugItem === null || item.pixiDebugItem === undefined) {
            ...
            PixiDebugRenderer.prototype.updateUnitInfo = function (xto, yto, rto, item) {
                ...
                if (ddinfo === null || ddinfo === undefined)
                    return;
                if (item.c_rayInfo === null || item.c_rayInfo === undefined)
                    return;
