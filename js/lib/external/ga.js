...
(function (global) {
    ...
    Chromosome.prototype = {
         ...
         * @returns {undefined}
         */
        burstMutate: function (burst_magnitude_) {
    ...
    var GATrainer = function (net, options_, initGene) {
        ...
        for (var i = 0; i < this.population_size; i++) {
            ...
            if (initChromosome) {
                ...
                if (i > 0) {
                    chromosome.burstMutate(this.mutation_size);
                }
            } else {
        ...
        train: function (fitFunc) {
            ...
            if (bestFitness < this.bestFitness) {
                ...
                if (this.bestFitnessCount > this.burst_generations) {
                    for (i = 1; i < N; i++) {
                        c[i].copyFrom(c[0]);
                        c[i].burstMutate(this.mutation_size);
                    }
                    //c[0].burstMutate(this.mutation_size); // don't mutate best solution.
                }
