(function (global) {
    ...
    var TileMap = function (opts) {
        ...
        this.mousemove = this.touchmove = function (event) {
            ...
            if (this.dragging) {
                ...
                this.mouseOverTileCoords = [Math.floor(this.mouseOverPoint[0] / (this.tileSize * this.zoom)),
                ...
                this.mouseOverGraphics.drawRect(this.mouseOverTileCoords[0] * this.tileSize,
    ...
    var Menu = function (tilemap, opts) {
        PIXI.Container.call(this);
